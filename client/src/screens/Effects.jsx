...
export default function Effects() {
  ...
  return (
    <div className="about">
      ...
      <p className="intro">
        If you've ever experienced a food coma, you probably concluded that
        certain types of food have an effect on your body and its functions.
        Here are a few of the good and bad ways that certain food items can
