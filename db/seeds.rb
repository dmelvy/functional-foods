...
@spinach = FoodItem.create!(name: 'Spinach', img_url: 'https://pngimg.com/uploads/spinach/spinach_PNG65.png', score: 5, user: @admin, effects: [@anti-inflammatory, @physical_energy, @mental_energy])
