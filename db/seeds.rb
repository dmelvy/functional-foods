...
@ginger = FoodItem.create!(name: 'Ginger', img_url: 'http://assets.stickpng.com/images/5b4eed0cc051e602a568ce0c.png', score: 5, user: @admin, effects: [@anti_inflammatory, @mental_energy])
@spinach = FoodItem.create!(name: 'Spinach', img_url: 'https://pngimg.com/uploads/spinach/spinach_PNG65.png', score: 5, user: @admin, effects: [@anti_inflammatory, @physical_energy, @mental_energy])
